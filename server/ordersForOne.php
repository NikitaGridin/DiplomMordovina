...
$sql = "SELECT orders.id as order_id, orders.created_at as order_created_at, orders.allprice as order_allprice, orders.count as order_count, orders.status as order_status, product_orders.count as product_count, product.*
        FROM orders
